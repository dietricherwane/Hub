...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": cliquer pour afficher par ordre croissant",sSortDescending:": cliquer pour afficher par ordre décroissant"},oPaginate:{sFirst:"Première",sLast:"Dernière",sNext:"Suivante",sPrevious:"Précédente"},sEmptyTable:"Aucune donnée à afficher",sInfo:"Affichage de _START_ à _END_ sur _TOTAL_ entrées",sInfoEmpty:"Affichage de 0 à 0 sur 0 entrées",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"Afficher _MENU_ entrées",sLoadingRecords:"Chargement...",sProcessing:"Chargement...",sSearch:"Recherche: ",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Aucune correspondance trouvée"},oSearch:g.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};V(p.defaults);p.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["Croissant","Décroissant"],bSearchable:!0,
